...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>Registration</title>
...
<input type="text" id="name" name="name" required="required" placeholder="Eg.User">
</div>
<div>
<label for="rollno">Staff no./ Roll no.</label> 
<input type="text" id="rollno" name="rollno" required="required" placeholder="Eg. 567" >
</div>
<div>
<label for="userid">UserId</label>
<input type="text" id="userid" name="userid" required="required" placeholder="Eg. User">
</div>
<div>
<label for="password">Password</label> 
<input type="password" id="password" name="password" required="required" placeholder="Eg. password">
</div>
<div>
...
<input type="text" id="dpt" name="dpt" required="required" placeholder="Eg. BCA">
</div> 
<div>
<label for="mail">E-mail</label> 
<input type="text" id="mail" name="mail" required="required" placeholder="Eg.gkkrishna@gmail.com">
</div> 
<div>
