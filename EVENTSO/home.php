...
$res=mysqli_query($connection,$q) or die(mysql_error($connection));
$row=mysqli_fetch_array($res);
?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>EVENT Management</title>
...
<body>
    ...
    <div id="bg"><div><table cellpadding="0" cellspacing="0"><tr><td><img alt="" src="home_includes/flowering_grasses-wallpaper-3840x2160.jpg" /></td></tr></table></div></div>
